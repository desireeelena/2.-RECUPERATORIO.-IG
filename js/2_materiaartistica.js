// Lista de Datos curiosos sobre Laurie Anderson
const datos = [
...
const datoCurioso = document.querySelector(".dato-curioso");
const botonDato = document.querySelector(".boton-dato");

// Muestra un dato curioso aleatorio
function mostrarDato() {
    const numeroAleatorio = Math.floor(Math.random() * datos.length);

    datoCurioso.textContent = datos[numeroAleatorio];
}

mostrarDato();

// Cambia a un nuevo dato curioso al hacer clic en el botón
